...
export default function Page (){
  return(
    ...
    <li className="hover:text-green-500 hover:underline"><Link href="">Week 5 Assignment</Link></li>
    <li className="hover:text-green-500 hover:underline"><Link href="">Week 6 Assignment</Link></li>
    <li className="hover:text-green-500 hover:underline"><Link href="">Week 7 Assignment</Link></li>
